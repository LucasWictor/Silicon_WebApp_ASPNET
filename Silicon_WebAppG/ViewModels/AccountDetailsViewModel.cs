...
namespace Silicon_WebAppG.ViewModels;
...
public class AccountBasicInfo
{
    ...
    [Display(Name = "Phone (optional)", Prompt = "Enter your phone (optional)")]
...
public class AccountAddressInfo
{
    ...
    [Required]
    [Display(Name = "Postal code 1", Prompt = "Enter your postal code")]
